#!/usr/bin/env bash
# Home Assistant Ubuntu Installer Kickstarter
# Copyright (C) 2016 Jonathan Baginski - All Rights Reserved
# Copyright (C) 2016 Dale Higgs - All Rights Reserved
...
while getopts ":n" opt; do
  case $opt in
    ...
    git clone -b ubuntu https://github.com/dale3h/fabric-home-assistant.git
